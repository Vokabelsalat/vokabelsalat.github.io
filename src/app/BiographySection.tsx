    ...
    <section className="flex overflow-hidden flex-col px-6 py-2.5 w-full text-content max-md:px-5 max-md:max-w-full">
      ...
      <article className="flex gap-2.5 items-start w-full text-xs max-md:max-w-full">
        <p className="flex-1 shrink w-full basis-0 min-w-60 max-md:max-w-full">
          I am a postdoctoral researcher at the <a className="underline hover:text-link" href="https://www4.uib.no/en/research/research-centres/center-for-digital-narrative">Center for Digital Narrative</a> at the <a href="https://www4.uib.no/en" className="underline hover:text-link">University of Bergen</a>, within the <a className="underline hover:text-link" href="https://www.uib.no/en/leadai">LEAD AI</a> programme.<br />
          My current projects explore how visualization and storytelling can make complex data systems understandable and usable.
          In <a href="https://codeberg.org/nickmontfort/narrative-nubs" className="underline hover:text-link">Narrative Nubs</a>, I apply this to story generator systems by developing interactive visualizations: glyphs that summarize and compare generators, and visual views that help users inspect outputs and follow the generation process so the internal logic becomes understandable and open to hands-on exploration.<br />
