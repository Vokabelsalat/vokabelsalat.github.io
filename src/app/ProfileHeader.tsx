...
const contactLinks: ContactLink[] = [
  ...
  },
  {
    ...
    icon: <FontAwesomeIcon className="scale-140" icon={faGoogleScholar} />,
    external: true,
  },
  {
    href: "https://orcid.org/0000-0002-1653-6614",
    label: "ORCID",
    icon: <FontAwesomeIcon className="scale-140" icon={faOrcid} />,
    external: true,
  },
  {
    href: "https://www.researchgate.net/profile/Jakob-Kusnick",
    label: "Research Gate",
    icon: <FontAwesomeIcon className="scale-140" icon={faResearchgate} />,
    external: true,
  },
  {
    href: "https://www.linkedin.com/in/jakob-kusnick-496208242/",
    label: "LinkedIn",
    icon: <FontAwesomeIcon className="scale-140" icon={faLinkedin} />,
    external: true,
  },
];
...
export const ProfileHeader: React.FC = () => {
  return (
    <header className="grid grid-cols-[min-content_auto_min-content] grid-rows-1 items-center px-6 py-2.5 w-full bg-white max-md:px-5 sticky top-0 border-b-1 border-gray-200 z-10">
      ...
      <div className="grid grid-cols-[80px_80px_80px] h-full w-min justify-between self-center">
        {contactLinks.map((link) => (
          ...
          >
            <div className="size-4 fill-blue-400">{link.icon}</div>
            <div className="opacity-0 group-hover:opacity-100">{link.label}</div>
          </a>
        ))}
        {/* <a
